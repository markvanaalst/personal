const Profile = () => {
  return (
    <div className="w-full max-w-xs py-8 mt-4 mb-8 overflow-hidden text-center text-2xs bg-theme-bg-alt text-theme-text">
      ...
      <p className="px-8 py-2">
        ...
        employer, any associations, or any other organizations I am a member of.
      </p>
    </div>
  )
}
