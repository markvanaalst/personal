...
const Profile = () => {
  return (
    <Card className="border-none">
      <CardContent className="w-full max-w-xs p-4 mt-4 mb-8 overflow-hidden">
        <Image
        ...
        <div className="flex items-center w-full gap-3 p-4 text-center sm:gap-x-5">
          <Link
          ...
          <Link
            href="https://github.com/markvanaalst"
            className="mb-2 inline-block rounded px-6 py-2.5 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg"
          ...
          <Link
            href="https://twitter.com/markvanaalst"
            className="mb-2 inline-block rounded px-6 py-2.5 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg"
