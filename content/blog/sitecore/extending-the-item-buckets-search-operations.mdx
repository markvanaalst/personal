...
Notice the value in the "Type" field. This is a command that needs to be mapped with the class and
assembly that contains the logic. The mapping is handled by configuration files within the
App_Config\\Include folder. Create a new config file that contains the following xml
